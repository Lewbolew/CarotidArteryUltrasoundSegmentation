...
#----------------------------INPUT PARAMETERS---------------------------
WEIGHT_PATH = '../../weights/Unet/full_augmentation_data/augmentation_experiments/rgb/'
DATASET_NAME = 'rgb_all_types_of_aug'
DATA_PATH = '../../dataset/augmentation/{}/'.format(DATASET_NAME)
...
save(history, '../../weights/Unet/full_augmentation_data/augmentation_experiments/{}.dat'.format(DATASET_NAME))
