...
#----------------------------INPUT PARAMETERS---------------------------
WEIGHT_PATH = '../../weights/Unet/full_augmentation_data/unet_on_artifacts/'
DATA_PATH = '../../dataset/augmentation/artifacts_augmentation/'
...
filepath = "best_weights_artifacts.hdf5"
...
save(history, 'artifacts_history')
