...
DATASET_NAME = 'rgb_color_aug'
DATA_PATH = '../../dataset/augmentation/softmax/{}/'.format(DATASET_NAME)
WEIGHT_PATH = '../../weights/Unet/augmentation_experiments/weightsSoftmax/{}.hdf5'.format(DATASET_NAME)
HISTORY_PATH = '../../weights/Unet/augmentation_experiments/history_of_trainingSoftmax/'
...
# X, y = data_loader_softmax(DATA_PATH, is_test=True)
...
dict_with_prediction_data['name_of_the_dataset'] = DATASET_NAME
dict_with_prediction_data['predictions'] = predictions
dict_with_prediction_data['x'] = X
dict_with_prediction_data['y'] = y

if DATASET_NAME in ''.join(os.listdir(HISTORY_PATH)):
    dict_with_prediction_data['history_of_training'] = pickle.load(open(HISTORY_PATH+DATASET_NAME+'.dat', 'rb'))
else:
    dict_with_prediction_data['history_of_training'] = None

# Save the results
save(dict_with_prediction_data, PATH_TO_SAVE+'.dat')
