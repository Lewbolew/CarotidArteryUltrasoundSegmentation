...
#----------------------------INPUT PARAMETERS---------------------------
WEIGHT_PATH = '../../weights/Unet/full_augmentation_data/unet_on_tissue/'
DATA_PATH = '../../dataset/augmentation/tissue_augmentation/'
...
filepath = "best_weights_tissue.hdf5"
